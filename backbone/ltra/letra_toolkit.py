...
def translate_advanced(source, target, segments, model_name="llama2"):
    """
    ...
    messages = [
        {
            'role': 'system',
            'content': f'Translate from {source} to {target}. This is a song lyric if you couldn\'t tell. If a phrase turns into a multiple word phrase, divide up the timestamps between the multiple new words as you see fit, do not over extend the total time of the original phrase. Respond only with the translated segments in the format: [start_time --> end_time]: translated text',
        },
        {
            'role': 'user',
            'content': f'{segments}',
